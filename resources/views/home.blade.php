               ...
               <div class="col-xl-12">
                  ...
                  {{--      {{$user->subscription()->stripe_plan}} --}}
                       ...
                       <div class="media-body">
                           <h6 class="media-title"><a href="#">{{$user->subscrip->plan->name}}</a> </h6>
                           <ul class="list-inline list-inline-dotted text-muted mb-2">
                               <li class="list-inline-item"><i class="icon-book-play mr-2"></i> {{$user->subscrip->plan->cost}} Dkk<span class="badge badge-success">12</span>
