...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-8">
                    ...
                    <div class="d-flex align-items-center mb-3 mb-sm-0">
                        ...
                        <div class="ml-3">
                            <h5 class="font-weight-semibold mb-0">38,289 <span
                                    class="text-success font-size-sm font-weight-normal"><i class="icon-arrow-up12"></i> (+16.2%)</span>
                            </h5>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="mr-3">
                                        <a href="#">
                                            <img src="{{ asset('asset/global_assets/images/brands/facebook.png')}}"
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="mr-3">
                                        <a href="#">
                                            <img src="{{ asset('asset/global_assets/images/brands/youtube.png')}}"
                                                 class="rounded-circle" width="32" height="32" alt="">
                                        </a>
                                    </div>
                                    <div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="mr-3">
                                        <a href="#">
                                            <img src="{{ asset('asset/global_assets/images/brands/spotify.png')}}"
                                                 class="rounded-circle" width="32" height="32" alt="">
                                        </a>
                                    </div>
                                    <div>
            ...
            <div class="card">
                <div class="card-header header-elements-sm-inline">
                    <h6 class="card-title">Next Delivery</h6>
                    ...
                    <div class="d-flex align-items-center mb-3 mb-md-0">
                        ...
                        <div class="ml-3">
                            <h5 class="font-weight-semibold mb-0">14,327 <span
                                    class="text-success font-size-sm font-weight-normal"><i class="icon-arrow-up12"></i> (+2.9%)</span>
                            </h5>
                ...
                <div class="table-responsive">
                    <table class="table text-nowrap">
                        ...
                        <tr>
                            <td class="text-center">
                                <h6 class="mb-0">12</h6>
                                <div class="font-size-sm text-muted line-height-1">Sept</div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        <a href="#" class="text-default font-weight-semibold letter-icon-title">Annabelle
                                            Doney</a>
                                        <div class="text-muted font-size-sm"><span
                                                class="badge badge-mark border-blue mr-1"></span> Active
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <a href="#" class="text-default">
                                    <div class="font-weight-semibold">A rich and intense ristretto
                                    </div>
                                    <span class="text-muted">A rich and intense ristretto ....</span>
                                </a>
                            </td>
                            <td class="text-center">
                                <div class="list-icons">
                                    <div class="list-icons-item dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a href="#" class="dropdown-item"><i
                                                    class="icon-checkmark3 text-success"></i> Delivered</a>
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h6 class="card-title">Running Package</h6>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <a href="#" class="text-default font-weight-semibold letter-icon-title">Package 01</a>
                                        <div class="text-muted font-size-sm"><i
                                                class="icon-checkmark3 font-size-sm mr-1"></i> New order
                                        </div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <a href="#" class="text-default font-weight-semibold letter-icon-title">Package 02</a>
                                        <div class="text-muted font-size-sm"><i
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <a href="#" class="text-default font-weight-semibold letter-icon-title">Package 03</a>
                                        <div class="text-muted font-size-sm"><i
